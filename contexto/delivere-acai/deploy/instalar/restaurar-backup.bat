...
setlocal
if "%~1"=="" (
  echo Uso: restaurar-backup.bat "C:\caminho\para\acaidb-backup-AAAA-MM-DD.zip"
  echo.
  echo Execute este script na pasta app ^(onde fica data^) quando for reinstalar o sistema
  echo e quiser voltar os dados a partir de um backup. Feche a aplicacao antes de restaurar.
  exit /b 1
)
